...
namespace CampaignKit.PortfolioImporter.Entities.HeroLab
{
	...
	#region HeroLab Character Class
	...
	public class HeroLabCharacter : Character
	{
		...
		{
			Statblock5e statblock = new Statblock5e(this);
		...
		public string getCharacterName()
		{
			...
			if (detailDocument.Name != null) { sb.Append(detailDocument.Name); }
		...
		public List<string> getCharacterType()
		{
			...
			if ((detailDocument.Types != null) && (detailDocument.Types.Type != null) && (detailDocument.Types.Type.Count > 0))
			{
				foreach (Type typ in detailDocument.Types.Type)
				{
					result.Add(typ.Name);
				}
			}
		...
		{
			StringBuilder sb = new StringBuilder();
			if (detailDocument.Alignment != null) { sb.Append(detailDocument.Alignment.Name); }
			return sb.ToString().Trim();
		}
		...
		{
			StringBuilder sb = new StringBuilder();
			if (detailDocument.Armorclass != null) { sb.Append(detailDocument.Armorclass.Ac); }
			return sb.ToString().Trim();
		}
		...
		{
			StringBuilder sb = new StringBuilder();
			if (detailDocument.Health != null) { sb.Append(detailDocument.Health.Hitpoints); }
			return sb.ToString().Trim();
		}
		...
		{
			StringBuilder sb = new StringBuilder();
			if (detailDocument.Health != null) { sb.Append(detailDocument.Health._Hitdice); }
			return sb.ToString().Trim();
		}
		...
		{
			StringBuilder sb = new StringBuilder();
			if (detailDocument.Movement != null) { sb.Append(detailDocument.Movement.Speed); }
			return sb.ToString().Trim();
		}
		...
		public List<string> getImmunities()
		{
			...
			if (is5e())
			{
				if (detailDocument.Damageimmunities != null)
				{
					string[] arr = detailDocument.Damageimmunities.Text.Split(',');
				...
				if (detailDocument.Conditionimmunities != null)
				{
					string[] arr = detailDocument.Conditionimmunities.Text.Split(',');
					foreach (string item in arr)
					{
						if (!string.IsNullOrEmpty(item))
						{
			...
			{
				if (detailDocument.Immunities != null && detailDocument.Immunities.Special != null && detailDocument.Immunities.Special.Count > 0)
				{
					foreach (Special sp in detailDocument.Immunities.Special)
					{
		...
		public List<string> getResistances()
		{
			...
			if (is5e())
			{
				if (detailDocument.Damageresistances != null)
				{
					string[] arr = detailDocument.Damageresistances.Text.Split(',');
					result.AddRange(arr.ToList<string>());
				};
			}
			else
			{
				if (detailDocument.Damagereduction != null && detailDocument.Damagereduction.Special != null && detailDocument.Damagereduction.Special.Count > 0)
				{
					foreach (Special sp in detailDocument.Damagereduction.Special)
					{
						result.Add(sp.Shortname);
					}
				}
				if (detailDocument.Resistances != null && detailDocument.Resistances.Special != null && detailDocument.Resistances.Special.Count > 0)
				{
					foreach (Special sp in detailDocument.Resistances.Special)
					{
						result.Add(sp.Shortname);
					}
				}
		...
		public List<string> getWeaknesses()
		{
			...
			if (is5e())
			{
				if (detailDocument.Damagevulnerabilities != null)
				{
					string[] arr = detailDocument.Damageresistances.Text.Split(',');
					result.AddRange(arr.ToList<string>());
				}
			...
			{
				if (detailDocument.Weaknesses != null && detailDocument.Weaknesses.Special != null && detailDocument.Weaknesses.Special.Count > 0)
				{
					foreach (Special sp in detailDocument.Weaknesses.Special)
					{
						result.Add(sp.Shortname);
					}
				}
		...
		{
			List<string> result = new List<string>();
			if (detailDocument.Senses != null && detailDocument.Senses.Special != null && detailDocument.Senses.Special.Count > 0)
			{
				foreach (Special sp in detailDocument.Senses.Special)
				{
					result.Add(sp.Name);
				}
			}
		...
		{
			List<string> result = new List<string>();
			if (detailDocument.Auras != null && detailDocument.Auras.Special != null && detailDocument.Auras.Special.Count > 0)
			{
				foreach (Special sp in detailDocument.Auras.Special)
				{
					result.Add(sp.Name);
				}
			}
		...
		{
			List<string> result = new List<string>();
			if (detailDocument.Languages != null && detailDocument.Languages.Language != null && detailDocument.Languages.Language.Count > 0)
			{
				foreach (Language ln in detailDocument.Languages.Language)
				{
					result.Add(ln.Name);
				}
			}
		...
		{
			StringBuilder sb = new StringBuilder();
			if (detailDocument.Challengerating != null) { sb.Append(detailDocument.Challengerating.Value); }
			return sb.ToString();
		}
		...
		{
			StringBuilder sb = new StringBuilder();
			if (detailDocument.Xpaward != null) { sb.Append(detailDocument.Xpaward.Value); }
			return sb.ToString();
		}
		...
		public Dictionary<string, string> getSpecial()
		{
			...
			if (detailDocument.Otherspecials != null && detailDocument.Otherspecials.Special != null && detailDocument.Otherspecials.Special.Count > 0)
			{
				foreach (Special sp in detailDocument.Otherspecials.Special)
				{
					if (!result.ContainsKey(sp.Shortname))
					{
						result.Add(sp.Shortname, sp.Description);
					}
				}
			}
			if (detailDocument.Attack != null && detailDocument.Attack.Special != null && detailDocument.Attack.Special.Count > 0)
			{
				foreach (Special sp in detailDocument.Attack.Special)
				{
					if (!result.ContainsKey(sp.Shortname))
					{
						result.Add(sp.Shortname, sp.Description);
			...
			if (detailDocument.Spelllike != null && detailDocument.Spelllike.Special != null && detailDocument.Spelllike.Special.Count > 0)
			{
				foreach (Special sp in detailDocument.Spelllike.Special)
				{
					if (!result.ContainsKey(sp.Shortname))
					{
						result.Add(sp.Shortname, sp.Description);
		...
		{
			Dictionary<string, string> result = new Dictionary<string, string>();
			if (detailDocument.Feats != null && detailDocument.Feats.Feat != null && detailDocument.Feats.Feat.Count > 0)
			{
				foreach (Feat sp in detailDocument.Feats.Feat)
				{
		...
		{
			Dictionary<string, string> result = new Dictionary<string, string>();
			if (detailDocument.Traits != null && detailDocument.Traits.Trait != null && detailDocument.Traits.Trait.Count > 0)
			{
				foreach (Trait sp in detailDocument.Traits.Trait)
				{
					result.Add(sp.Name, sp.Description);
				}
			}
		...
		{
			Dictionary<string, string> result = new Dictionary<string, string>();
			if (detailDocument.Skills != null && detailDocument.Skills.Skill != null && detailDocument.Skills.Skill.Count > 0)
			{
				foreach (Skill sp in detailDocument.Skills.Skill)
				{
					string bonus;
					if (is5e())
					{
		...
		public Dictionary<string, string> getSaves()
		{
			...
			{
				if (detailDocument.Saves != null && detailDocument.Saves.Save != null && detailDocument.Saves.Save.Count > 0)
				{
					foreach (Save sv in detailDocument.Saves.Save)
					{
